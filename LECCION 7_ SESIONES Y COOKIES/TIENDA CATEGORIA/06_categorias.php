...
<div id="productos">
    ...
    foreach ($relojes as $codigo => $elemento) {
        if ($elemento[categoria] == "espiritual") {
            $espiritual[$codigo]= $relojes[$codigo];
         } else {
            $material[$codigo]= $relojes[$codigo];
         } 
    }  
    
   if ($categoria == "espiritual"){ 
        foreach ($espiritual as $cod => $elemento) {
    ?>
        <div class="pro" >
    ...
    <?php
        ...
        foreach ($material as $cod => $elemento) {
    ?>
         <div class="pro" >
                <img src="<?= $elemento[imagen] ?>" width="110" border="1">
                <br> <?= $elemento[nombre] ?><br>
